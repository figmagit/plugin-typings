...
interface PluginAPI {
   ...
   * This means properties such as {@link ChildrenMixin.children} and methods such as {@link ChildrenMixin.findAll} will exclude these nodes.
   * {@link PluginAPI.getNodeById} will return `null` for these nodes, and accessing any property on an existing node object for one of these nodes will throw an error.
   *
   ...
   * - `onDequeue`: A function that will run when the notification is dequeued. This can happen due to the timeout being reached, the notification being dismissed by the user, or the user clicking the notification's `button`.
   ...
   *
   * Read more in the [constants section](https://www.figma.com/plugin-docs/api/figma-constants-colors).
   */
   ...
   *
   * Caution: This API is currently in public beta and is subject to change.
   * */
   ...
   *
   * @throws imageTooSmall, imageTooLarge, imageUnsupportedType
   */
   ...
   *
   * @throws videoOnlyPro, videoOnlyMp4, videoLessThan100Mb
   */
   ...
   *
   * @throws needAtLeastOne, insertIndexTooLarge, groupSamePage, cannotMoveRoot, cannotMoveCycle, cannotMoveNonPageToRoot, cannotMovePageToNonRoot, cannotMoveNoChildren, cannotMoveInternalParent, cannotMoveInternal, cannotMoveToInstance, cannotMoveInInstance, cannotMoveComponentCycle, cannotMoveNestedComponent, cannotMoveComponentSetCycle, cannotMoveNonComponentToComponentSet
   */
  combineAsVariants(
   ...
   * @throws cannotUngroupInstance, cannotUngroupComponent, cannotUngroupNonGroupLike, cannotUngroupNode
   */
...
interface VariablesAPI {
   ...
   * @param collectionId - the ID of the collection for this new variable
...
/**
 * @see https://www.figma.com/plugin-docs/api/figma-constants-colors
 */
interface ConstantsAPI {
  /**
   * Maps name of all the FigJam base colors to their corresponding hex values.
   *
   * @remarks
   *
   * FigJam base colors:
   * - Black `#1E1E1E` <span style={{backgroundColor: "#1E1E1E", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6" }}></span>
   * - Gray `#B3B3B3` <span style={{backgroundColor: "#B3B3B3", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6"}}></span>
   * - Red `#F24822` <span style={{backgroundColor: "#F24822", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6"}}></span>
   * - Orange `#FFA629` <span style={{backgroundColor: "#FFA629", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6"}}></span>
   * - Yellow `#FFCD29` <span style={{backgroundColor: "#FFCD29", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6"}}></span>
   * - Green `#14AE5C` <span style={{backgroundColor: "#14AE5C", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6"}}></span>
   * - Blue `#0D99FF` <span style={{backgroundColor: "#0D99FF", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6"}}></span>
   * - Violet `#9747FF` <span style={{backgroundColor: "#9747FF", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6"}}></span>
   * - White `#FFFFFF` <span style={{backgroundColor: "#FFFFFF", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6"}}></span>
   *
   */
  figJamBase: ColorPalette
  /**
   * Maps name of all the FigJam base light colors to their corresponding hex values.
   *
   * @remarks
   *
   * FigJam base light colors:
   * - Dark Gray `#757575` <span style={{backgroundColor: "#757575", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6" }}></span>
   * - Light Gray `#E6E6E6` <span style={{backgroundColor: "#E6E6E6", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6" }}></span>
   * - Light Red `#FFC7C2` <span style={{backgroundColor: "#FFC7C2", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6" }}></span>
   * - Light Orange `#FCD19C` <span style={{backgroundColor: "#FCD19C", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6" }}></span>
   * - Light Yellow `#FFE8A3` <span style={{backgroundColor: "#FFE8A3", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6" }}></span>
   * - Light Green `#AFF4C6` <span style={{backgroundColor: "#AFF4C6", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6" }}></span>
   * - Light Blue `#BDE3FF` <span style={{backgroundColor: "#BDE3FF", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6" }}></span>
   * - Light Violet `#E4CCFF` <span style={{backgroundColor: "#E4CCFF", height: "0.75rem", width: "0.75rem", display: "inline-block", border: "1px solid #e6e6e6" }}></span>
   *
   */
...
interface VectorVertex {
  ...
  /**
   * How to two curve handles behave relative to one another. Defaults to the node's property if left unspecified.
   */
...
interface ChildrenMixin {
   ...
   *
   * @throws cannotMoveRoot, cannotMoveCycle, cannotMoveNonPageToRoot, cannotMovePageToNonRoot, cannotMoveNoChildren, cannotMoveInternalParent, cannotMoveInternal, cannotMoveToInstance, cannotMoveInInstance, cannotMoveComponentCycle, cannotMoveNestedComponent, cannotMoveComponentSetCycle, cannotMoveNonComponentToComponentSet
   */
   ...
   * If this is called on an auto-layout frame, calling this function can cause this layer to be resized and children to be moved.
   *
   * @throws insertIndexTooLarge, cannotMoveRoot, cannotMoveCycle, cannotMoveNonPageToRoot, cannotMovePageToNonRoot, cannotMoveNoChildren, cannotMoveInternalParent, cannotMoveInternal, cannotMoveToInstance, cannotMoveInInstance, cannotMoveComponentCycle, cannotMoveNestedComponent, cannotMoveComponentSetCycle, cannotMoveNonComponentToComponentSet
   */
...
interface ReactionMixin {
   ...
   *   frame.setBoundVariable('visible', showVariable.id)
   *
   *   toggleButton.reactions = [
   *   {
   *     trigger: { type: 'ON_CLICK' },
   *     actions: [
   *     {
...
interface NonResizableTextMixin {
  ...
  /**
   * Get the {@link NonResizableTextMixin.openTypeFeatures} from characters in range `start` (inclusive) to `end` (exclusive).
   */
   ...
   * ```
   *
   * See {@link NonResizableTextMixin.insertCharacters} for more information on surrogate pairs.
   */
...
interface DocumentNode extends BaseNodeMixin {
   ...
   * ```ts
   * const emptyPages = figma.root.findChildren(n => n.children.length === 0)
   * ```
   */
   ...
   * ```ts
   * const firstEmptyPage = figma.root.findChild(n => n.children.length === 0)
   * ```
   */
...
interface PageNode extends BaseNodeMixin, ChildrenMixin, ExportMixin, ExplicitVariableModesMixin {
   ...
   *
   * @throws cannotSelectDocument, cannotSelectPage, cannotSelectOutsidePage
   */
...
interface TextNode extends DefaultShapeMixin, ConstraintMixin, NonResizableTextMixin {
   ...
   * @remarks
   *
   * When {@link TextNode.textAutoResize} is set to `"NONE"`, the text will truncate when the fixed size is smaller than the text insdie. When it is `"HEIGHT"` or `"WIDTH_AND_HEIGHT"`, truncation will only occur if used in conjunction with {@link DimensionAndPositionMixin.maxHeight} or {@link TextNode.maxLines}.
   */
...
interface InstanceNode extends DefaultFrameMixin, VariantMixin {
   ...
   * @remarks
   *
   * Learn more about instance swap and override preservation in our <a href="https://help.figma.com/hc/en-us/articles/360039150413-Swap-between-component-instances-in-a-file">help center</a>. If you do not want to preserve overrides when swapping, you should use `mainComponent`, which sets the instance's main component directly and clears all overrides.
   */
  swapComponent(componentNode: ComponentNode): void
  /**
   * Sets the component properties and values for this instance. `propertyName` corresponds to the names returned by `componentPropertyDefinitions` and should be suffixed with `'#'` and a unique ID for `'TEXT'`, `'BOOLEAN'`, and `'INSTANCE_SWAP'` properties. In the case of name collision, this function prioritizes updating the `'VARIANT'` type properties. Existing properties that are non-specified in the function will maintain their current value. In the case of `VariableAlias` values, these are only supported on `VARIANT` properties at this time.
   */
...
interface Variable extends PluginDataMixin {
   ...
   *
   * const frame = figma.createFrame()
   * frame.setExplicitVariableModeForCollection(collection.id, mode1Id)
   * // Output: {value: 1, resolvedType: 'FLOAT'}
   * console.log(variable.resolveForConsumer(frame))
   *
   * frame.setExplicitVariableModeForCollection(collection.id, mode2Id)
   ...
   * const frame = figma.createFrame()
   *
   * frame.setExplicitVariableModeForCollection(collection1.id, collection1Mode1Id)
   * frame.setExplicitVariableModeForCollection(collection2.id, collection2Mode1Id)
   * // Output: {value: 1, resolvedType: 'FLOAT'}
   * console.log(collection2Var.resolveForConsumer(frame))
   *
   * frame.setExplicitVariableModeForCollection(collection1.id, collection1Mode2Id)
   * frame.setExplicitVariableModeForCollection(collection2.id, collection2Mode1Id)
   * // Output: {value: 2, resolvedType: 'FLOAT'}
   * console.log(collection2Var.resolveForConsumer(frame))
   *
   * frame.setExplicitVariableModeForCollection(collection1.id, collection1Mode1Id)
   * frame.setExplicitVariableModeForCollection(collection2.id, collection2Mode2Id)
...
interface TextStyle extends BaseStyleMixin {
  ...
  type: 'TEXT'
  /**
   * Value to replace the text {@link NonResizableTextMixin.fontSize} with.
   */
  fontSize: number
  /**
  ...
  textDecoration: TextDecoration
  /**
   * Value to replace the text {@link NonResizableTextMixin.fontName} with.
   */
  fontName: FontName
  /**
   * Value to replace the text {@link NonResizableTextMixin.letterSpacing} with.
   */
  letterSpacing: LetterSpacing
  /**
  ...
  hangingList: boolean
  /**
   * Value to replace the text {@link NonResizableTextMixin.textCase} with.
   */
  textCase: TextCase
}
